...
void Display8() {
    ...
    glColor3f(1, 0.1, 0.1); // red
    glBegin(GL_POLYGON);
    glVertex2f(0.35 * scale_red, -0.606 * scale_red);
    glVertex2f(0.7 * scale_red, 0);
    glVertex2f(0.35 * scale_red, 0.606 * scale_red);
    glVertex2f(-0.35 * scale_red, 0.606 * scale_red);
    glVertex2f(-0.7 * scale_red, 0);
    glVertex2f(-0.35 * scale_red, -0.606 * scale_red);
    ...
    float scale_white = 0.67;

    glColor3f(1, 1, 1); // white
    glBegin(GL_POLYGON);
    glVertex2f(0.35 * scale_white, -0.606 * scale_white);
    glVertex2f(0.7 * scale_white, 0);
    glVertex2f(0.35 * scale_white, 0.606 * scale_white);
    glVertex2f(-0.35 * scale_white, 0.606 * scale_white);
    glVertex2f(-0.7 * scale_white, 0);
    glVertex2f(-0.35 * scale_white, -0.606 * scale_white);
